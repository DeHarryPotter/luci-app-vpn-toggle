...
```sh
cd /tmp
wget https://github.com/DeHarryPotter/luci-app-vpn-toggle/releases/latest/download/luci-app-vpn-toggle_1.0.10-1_all.ipk
opkg update
opkg install pbr
opkg install /tmp/luci-app-vpn-toggle_1.0.10-1_all.ipk
```
